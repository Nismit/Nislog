    ...
    <_AuthorCard className="author">
      ...
      <div>
        <div className="author__desc">
          <h3>Michinobu Nishimoto (<a href="https://twitter.com/nismit_" target="_blank" rel="noreferrer">@nismit_</a>)</h3>

          <p>記事を書いてる人: 日本のWeb制作会社に約2年半フロントエンドとして働いた後、カナダのバンクーバーで語学学校-&gt;専門学校-&gt;Web制作会社にフロントエンドとして就職。
            現在は現地のスタートアップでフロントエンドに従事している。<br /> 詳しく知りたい方は<a href={`${process.env.NEXT_PUBLIC_BASE_URL}/about`}>こちら</a>へ。</p>
