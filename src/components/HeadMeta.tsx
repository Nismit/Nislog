...
const HeadMeta: React.FC<Props> = ({ tags }) => {
    return (
        <Head>
            ...
            <meta property="og:image" key="og_image" content={tags.eyecatch ? `${process.env.NEXT_PUBLIC_BASE_URL}/${tags.eyecatch}` : `${process.env.NEXT_PUBLIC_BASE_URL}${data.siteImage}`}/>
            ...
            <meta name="twitter:image" key="twitter_img" content={tags.eyecatch ? `${process.env.NEXT_PUBLIC_BASE_URL}/${tags.eyecatch}` : `${process.env.NEXT_PUBLIC_BASE_URL}${data.siteImage}`}/>
