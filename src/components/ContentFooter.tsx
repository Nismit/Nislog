    ...
    <_ContentFooter>
      <ul className="single-share">
        <li className="single-share__item">
          <a className="single-share__link twitter"
        ...
        <li className="single-share__item">
          <a className="single-share__link facebook"
            href={`https://www.facebook.com/sharer.php?u=${process.env.NEXT_PUBLIC_BASE_URL}/${slug}&t=${title}`} 
            title="Facebookでシェア" 
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li className="single-share__item">
          <a className="single-share__link hatena"
        ...
        <li className="single-share__item">
          <a className="single-share__link pocket"
        ...
        <li className="single-share__item">
          <a className="single-share__link feedly"
